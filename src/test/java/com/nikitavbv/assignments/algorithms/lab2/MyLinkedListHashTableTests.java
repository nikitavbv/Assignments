...
public class MyLinkedListHashTableTests {

  @Test
  public void testAdd() {
    MyLinkedListHashTable<String, Integer> myHashTable = new MyLinkedListHashTable<>();
  ...
  public void testResize() {
    MyLinkedListHashTable<String, Integer> myHashTable = new MyLinkedListHashTable<>(2, true);
    myHashTable.put("foobar", 42);
    myHashTable.put("Aa", 1);
    myHashTable.put("BB", 2); // cause collision
